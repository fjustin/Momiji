        ...
        if (button.hasClass("decrement")) {
            ...
            $.ajax({url: "/likes", type: "post", data: {article_id: id, dataType: "json"}})
                .done(function (data) {
                    ...
                    heart.attr("src", "/assets/heart_red.png")
                    sum.text(data["count"])
                })
        }
    }
...
(function() {
  var bindTwitterEventHandlers, loadGoogleSDK, loadHatenaSDK, loadPocketSDK, loadTwitterSDK, ready, renderTweetButtons, twttr_events_bound;
